...
--
-- Name: auth_error_severity; Type: TYPE; Schema: public; Owner: -
--
...
--
-- Name: auth_error_type; Type: TYPE; Schema: public; Owner: -
--
...
--
-- Name: coverage_status_enum; Type: TYPE; Schema: public; Owner: -
--
...
--
-- Name: duration_category_enum; Type: TYPE; Schema: public; Owner: -
--
...
--
-- Name: employee_operation; Type: TYPE; Schema: public; Owner: -
--
...
--
-- Name: error_status_code; Type: TYPE; Schema: public; Owner: -
--
...
--
-- Name: jwt_algorithm; Type: TYPE; Schema: public; Owner: -
--
...
--
-- Name: operation_severity; Type: TYPE; Schema: public; Owner: -
--
...
--
-- Name: password_policy; Type: TYPE; Schema: public; Owner: -
--
...
--
-- Name: pattern_action_type; Type: TYPE; Schema: public; Owner: -
--
...
--
-- Name: period_format; Type: TYPE; Schema: public; Owner: -
--
...
--
-- Name: schedule_operation; Type: TYPE; Schema: public; Owner: -
--
...
--
-- Name: shift_duration_category; Type: TYPE; Schema: public; Owner: -
--
...
--
-- Name: shift_pattern_type_enum; Type: TYPE; Schema: public; Owner: -
--
...
--
-- Name: strong_password; Type: DOMAIN; Schema: public; Owner: -
--
...
--
-- Name: time_off_access_level; Type: TYPE; Schema: public; Owner: -
--
...
--
-- Name: time_off_status_enum; Type: TYPE; Schema: public; Owner: -
--
...
--
-- Name: time_off_type_enum; Type: TYPE; Schema: public; Owner: -
--
...
--
-- Name: timezone_policy; Type: TYPE; Schema: public; Owner: -
--
...
--
-- Name: analyze_auth_patterns(interval); Type: FUNCTION; Schema: public; Owner: -
--

CREATE FUNCTION public.analyze_auth_patterns(p_time_window interval DEFAULT '24:00:00'::interval) RETURNS TABLE(event_type text, total_events bigint, unique_users bigint, avg_events_per_user numeric)
...
--
-- Name: analyze_error_patterns(interval); Type: FUNCTION; Schema: public; Owner: -
--

CREATE FUNCTION public.analyze_error_patterns(p_time_window interval DEFAULT '24:00:00'::interval) RETURNS TABLE(component text, total_errors integer, total_recoveries integer, recovery_rate numeric, avg_recovery_attempts numeric, last_error timestamp with time zone)
    LANGUAGE plpgsql STABLE SECURITY DEFINER
    AS $$
BEGIN
    RETURN QUERY
...
--
-- Name: analyze_network_retry_patterns(interval); Type: FUNCTION; Schema: public; Owner: -
--

CREATE FUNCTION public.analyze_network_retry_patterns(p_time_window interval DEFAULT '24:00:00'::interval) RETURNS TABLE(component text, endpoint text, total_retries integer, success_rate numeric, avg_retry_delay numeric, max_retry_delay numeric, last_retry timestamp with time zone)
    LANGUAGE plpgsql STABLE SECURITY DEFINER
    AS $$
BEGIN
    RETURN QUERY
...
--
-- Name: FUNCTION begin_transaction(); Type: COMMENT; Schema: public; Owner: -
--
...
--
-- Name: calculate_period_coverage(date, uuid); Type: FUNCTION; Schema: public; Owner: -
--

CREATE FUNCTION public.calculate_period_coverage(p_date date, p_period_id uuid) RETURNS integer
    LANGUAGE plpgsql
    AS $$
DECLARE
    v_coverage integer;
...
--
-- Name: calculate_weekly_hours(uuid, date); Type: FUNCTION; Schema: public; Owner: -
--

CREATE FUNCTION public.calculate_weekly_hours(p_employee_id uuid, p_date date) RETURNS integer
    LANGUAGE plpgsql
    AS $$
DECLARE
...
--
-- Name: can_access_user_data(uuid, uuid); Type: FUNCTION; Schema: public; Owner: -
--

CREATE FUNCTION public.can_access_user_data(p_accessor_id uuid, p_target_id uuid) RETURNS boolean
    LANGUAGE plpgsql SECURITY DEFINER
    AS $$
DECLARE
...
--
-- Name: can_manage_time_off_requests(uuid); Type: FUNCTION; Schema: public; Owner: -
--

CREATE FUNCTION public.can_manage_time_off_requests(p_user_id uuid) RETURNS boolean
    LANGUAGE plpgsql SECURITY DEFINER
    SET search_path TO 'public'
    AS $$
declare
...
--
-- Name: FUNCTION can_manage_time_off_requests(p_user_id uuid); Type: COMMENT; Schema: public; Owner: -
--
...
--
-- Name: check_confirmation_rate_limit(text, text, integer, integer); Type: FUNCTION; Schema: public; Owner: -
--

CREATE FUNCTION public.check_confirmation_rate_limit(p_email text, p_ip_address text, p_window_minutes integer DEFAULT 60, p_max_attempts integer DEFAULT 5) RETURNS TABLE(allowed boolean, remaining_attempts integer, next_allowed_attempt timestamp with time zone)
    LANGUAGE plpgsql STABLE SECURITY DEFINER
    AS $$
DECLARE
    v_attempts INT;
...
--
-- Name: check_employee_dependencies(uuid); Type: FUNCTION; Schema: public; Owner: -
--

CREATE FUNCTION public.check_employee_dependencies(employee_id uuid) RETURNS jsonb
    LANGUAGE plpgsql SECURITY DEFINER
    SET search_path TO 'public'
    AS $_$
declare
...
--
-- Name: FUNCTION check_employee_dependencies(employee_id uuid); Type: COMMENT; Schema: public; Owner: -
--
...
--
-- Name: check_password_history(uuid, text, text); Type: FUNCTION; Schema: public; Owner: -
--

CREATE FUNCTION public.check_password_history(p_user_id uuid, p_new_password text, p_policy_name text DEFAULT 'default'::text) RETURNS boolean
    LANGUAGE plpgsql SECURITY DEFINER
    AS $$
DECLARE
...
--
-- Name: check_rate_limit(text, uuid); Type: FUNCTION; Schema: public; Owner: -
--

CREATE FUNCTION public.check_rate_limit(p_key text, p_user_id uuid DEFAULT NULL::uuid) RETURNS TABLE(allowed boolean, remaining integer, reset_at timestamp with time zone)
    LANGUAGE plpgsql SECURITY DEFINER
    AS $$
DECLARE
...
--
-- Name: check_schedule_conflicts(); Type: FUNCTION; Schema: public; Owner: -
--

CREATE FUNCTION public.check_schedule_conflicts() RETURNS trigger
    LANGUAGE plpgsql
    AS $$
DECLARE
...
--
-- Name: check_storage_quota_status(text); Type: FUNCTION; Schema: public; Owner: -
--

CREATE FUNCTION public.check_storage_quota_status(p_component text) RETURNS TABLE(current_size_bytes integer, max_size_bytes integer, usage_percentage double precision, needs_cleanup boolean, last_cleanup timestamp with time zone)
    LANGUAGE plpgsql STABLE SECURITY DEFINER
    AS $$
BEGIN
    RETURN QUERY
...
--
-- Name: cleanup_error_analytics_data(text); Type: FUNCTION; Schema: public; Owner: -
--

CREATE FUNCTION public.cleanup_error_analytics_data(p_component text) RETURNS void
    LANGUAGE plpgsql SECURITY DEFINER
    AS $$
DECLARE
...
--
-- Name: cleanup_error_analytics_storage(text, integer); Type: FUNCTION; Schema: public; Owner: -
--

CREATE FUNCTION public.cleanup_error_analytics_storage(p_component text, p_older_than_days integer DEFAULT 30) RETURNS integer
    LANGUAGE plpgsql SECURITY DEFINER
    AS $$
DECLARE
...
CREATE FUNCTION public.column_exists(p_table text, p_column text) RETURNS boolean
    LANGUAGE plpgsql
    AS $$
BEGIN
    RETURN EXISTS (
...
--
-- Name: FUNCTION commit_transaction(); Type: COMMENT; Schema: public; Owner: -
--
...
--
-- Name: employee_operations; Type: TABLE; Schema: public; Owner: -
--
...
--
-- Name: complete_employee_operation(uuid, text, text, text, text); Type: FUNCTION; Schema: public; Owner: -
--

CREATE FUNCTION public.complete_employee_operation(p_operation_id uuid, p_status text DEFAULT 'completed'::text, p_error_code text DEFAULT NULL::text, p_error_details text DEFAULT NULL::text, p_stack_trace text DEFAULT NULL::text) RETURNS public.employee_operations
    LANGUAGE plpgsql SECURITY DEFINER
    AS $$
DECLARE
...
--
-- Name: schedule_operations; Type: TABLE; Schema: public; Owner: -
--
...
--
-- Name: complete_schedule_operation(uuid, text, text); Type: FUNCTION; Schema: public; Owner: -
--

CREATE FUNCTION public.complete_schedule_operation(p_operation_id uuid, p_status text DEFAULT 'completed'::text, p_error_details text DEFAULT NULL::text) RETURNS public.schedule_operations
    LANGUAGE plpgsql SECURITY DEFINER
    AS $$
DECLARE
...
--
-- Name: convert_time_between_zones(time without time zone, text, text); Type: FUNCTION; Schema: public; Owner: -
--

CREATE FUNCTION public.convert_time_between_zones(p_time time without time zone, p_source_timezone text, p_target_timezone text) RETURNS time without time zone
...
--
-- Name: convert_timezone(timestamp with time zone, text, text); Type: FUNCTION; Schema: public; Owner: -
--

CREATE FUNCTION public.convert_timezone(p_timestamp timestamp with time zone, p_target_zone text, p_config_name text DEFAULT 'default'::text) RETURNS timestamp with time zone
    LANGUAGE plpgsql STABLE SECURITY DEFINER
    AS $$
DECLARE
...
CREATE FUNCTION public.delete_employee(employee_id uuid) RETURNS void
    LANGUAGE plpgsql SECURITY DEFINER
    SET search_path TO 'public'
    AS $_$
declare
...
--
-- Name: FUNCTION delete_employee(employee_id uuid); Type: COMMENT; Schema: public; Owner: -
--
...
--
-- Name: down_20240328000001(); Type: FUNCTION; Schema: public; Owner: -
--

CREATE FUNCTION public.down_20240328000001() RETURNS void
    LANGUAGE plpgsql
    AS $$
begin
...
--
-- Name: down_20240328000002(); Type: FUNCTION; Schema: public; Owner: -
--

CREATE FUNCTION public.down_20240328000002() RETURNS void
    LANGUAGE plpgsql
    AS $$
begin
...
--
-- Name: generate_schedule(date, date, uuid, text); Type: FUNCTION; Schema: public; Owner: -
--

CREATE FUNCTION public.generate_schedule(p_start_date date, p_end_date date, p_department_id uuid, p_environment text DEFAULT current_setting('app.environment'::text, true)) RETURNS TABLE(schedule_id uuid, metrics jsonb)
    LANGUAGE plpgsql SECURITY DEFINER
    AS $$
DECLARE
    v_constraints JSONB;
...
--
-- Name: get_auth_error_history(uuid, text, timestamp with time zone, timestamp with time zone); Type: FUNCTION; Schema: public; Owner: -
--

CREATE FUNCTION public.get_auth_error_history(p_user_id uuid DEFAULT NULL::uuid, p_action text DEFAULT NULL::text, p_start_time timestamp with time zone DEFAULT (now() - '24:00:00'::interval), p_end_time timestamp with time zone DEFAULT now()) RETURNS TABLE(error_id uuid, user_id uuid, action_type text, error_code text, error_message text, error_details jsonb, created_at timestamp with time zone)
    LANGUAGE plpgsql STABLE SECURITY DEFINER
    AS $$
BEGIN
    RETURN QUERY
...
--
-- Name: get_available_shifts(uuid, date); Type: FUNCTION; Schema: public; Owner: -
--

CREATE FUNCTION public.get_available_shifts(p_employee_id uuid, p_date date) RETURNS TABLE(shift_id uuid, shift_type_id uuid, start_time time without time zone, end_time time without time zone, duration_hours integer, validation jsonb)
    LANGUAGE plpgsql SECURITY DEFINER
    SET search_path TO 'public'
    AS $$
begin
...
--
-- Name: get_component_error_metrics(text, interval); Type: FUNCTION; Schema: public; Owner: -
--

CREATE FUNCTION public.get_component_error_metrics(p_component text, p_time_window interval DEFAULT '24:00:00'::interval) RETURNS TABLE(error_count integer, recovery_attempts integer, successful_recoveries integer, recovery_rate numeric, last_error timestamp with time zone)
    LANGUAGE plpgsql STABLE SECURITY DEFINER
    AS $$
BEGIN
    RETURN QUERY
...
--
-- Name: get_cookie_success_rate(text, text, interval); Type: FUNCTION; Schema: public; Owner: -
--

CREATE FUNCTION public.get_cookie_success_rate(p_cookie_name text, p_operation text DEFAULT NULL::text, p_time_window interval DEFAULT '24:00:00'::interval) RETURNS TABLE(total_operations bigint, successful_operations bigint, success_rate numeric, avg_duration_ms numeric)
    LANGUAGE plpgsql STABLE SECURITY DEFINER
    AS $$
BEGIN
    RETURN QUERY
...
--
-- Name: get_employees(text, public.employee_role, uuid); Type: FUNCTION; Schema: public; Owner: -
--
...
--
-- Name: get_error_action_history(text, timestamp with time zone, timestamp with time zone); Type: FUNCTION; Schema: public; Owner: -
--

CREATE FUNCTION public.get_error_action_history(p_path text DEFAULT NULL::text, p_start_time timestamp with time zone DEFAULT (now() - '24:00:00'::interval), p_end_time timestamp with time zone DEFAULT now()) RETURNS TABLE(action text, path text, user_id uuid, action_timestamp timestamp with time zone, metadata jsonb)
    LANGUAGE plpgsql STABLE SECURITY DEFINER
    AS $$
BEGIN
    RETURN QUERY
...
--
-- Name: get_error_analytics_data(text, text); Type: FUNCTION; Schema: public; Owner: -
--

CREATE FUNCTION public.get_error_analytics_data(p_component text, p_storage_key text) RETURNS TABLE(data jsonb, size_bytes integer, last_accessed timestamp with time zone)
    LANGUAGE plpgsql STABLE SECURITY DEFINER
    AS $$
BEGIN
    RETURN QUERY
...
--
-- Name: get_error_http_code(text); Type: FUNCTION; Schema: public; Owner: -
--

CREATE FUNCTION public.get_error_http_code(p_error_code text) RETURNS integer
    LANGUAGE plpgsql STABLE SECURITY DEFINER
    AS $$
BEGIN
    RETURN (
...
--
-- Name: jwt_templates; Type: TABLE; Schema: public; Owner: -
--
...
--
-- Name: get_jwt_template(text); Type: FUNCTION; Schema: public; Owner: -
--

CREATE FUNCTION public.get_jwt_template(template_name text) RETURNS public.jwt_templates
    LANGUAGE plpgsql SECURITY DEFINER
    AS $$
DECLARE
...
--
-- Name: get_pattern_action_history(uuid, uuid, public.pattern_action_type, timestamp with time zone, timestamp with time zone); Type: FUNCTION; Schema: public; Owner: -
--

CREATE FUNCTION public.get_pattern_action_history(p_pattern_id uuid DEFAULT NULL::uuid, p_user_id uuid DEFAULT NULL::uuid, p_action_type public.pattern_action_type DEFAULT NULL::public.pattern_action_type, p_start_date timestamp with time zone DEFAULT NULL::timestamp with time zone, p_end_date timestamp with time zone DEFAULT NULL::timestamp with time zone) RETURNS TABLE(action_id uuid, action_type public.pattern_action_type, pattern_id uuid, user_id uuid, pattern_name text, pattern_type text, error_message text, error_code text, metadata jsonb, created_at timestamp with time zone, client_info jsonb)
    LANGUAGE plpgsql SECURITY DEFINER
    AS $$
BEGIN
    RETURN QUERY
...
--
-- Name: get_pattern_violations(date); Type: FUNCTION; Schema: public; Owner: -
--

CREATE FUNCTION public.get_pattern_violations(start_date date) RETURNS TABLE(employee_id uuid, violation_type text, violation_date date, details text)
    LANGUAGE plpgsql
    AS $$
BEGIN
...
--
-- Name: get_rate_limit_metrics(text, uuid, timestamp with time zone); Type: FUNCTION; Schema: public; Owner: -
--

CREATE FUNCTION public.get_rate_limit_metrics(p_key text, p_user_id uuid DEFAULT NULL::uuid, p_window_start timestamp with time zone DEFAULT (now() - '24:00:00'::interval)) RETURNS TABLE(window_start timestamp with time zone, request_count integer, last_request timestamp with time zone)
    LANGUAGE plpgsql STABLE SECURITY DEFINER
    AS $$
BEGIN
    RETURN QUERY
...
--
-- Name: get_scheduler_config(text, text); Type: FUNCTION; Schema: public; Owner: -
--

CREATE FUNCTION public.get_scheduler_config(p_config_key text, p_environment text DEFAULT current_setting('app.environment'::text, true)) RETURNS jsonb
    LANGUAGE plpgsql SECURITY DEFINER
    AS $$
DECLARE
...
--
-- Name: get_scheduler_metrics_history(text, text, timestamp with time zone, timestamp with time zone); Type: FUNCTION; Schema: public; Owner: -
--

CREATE FUNCTION public.get_scheduler_metrics_history(p_metrics_type text, p_environment text DEFAULT current_setting('app.environment'::text, true), p_start_date timestamp with time zone DEFAULT (now() - '24:00:00'::interval), p_end_date timestamp with time zone DEFAULT now()) RETURNS TABLE(metrics_type text, metrics_value jsonb, measured_at timestamp with time zone)
    LANGUAGE plpgsql SECURITY DEFINER
    AS $$
BEGIN
    RETURN QUERY
...
--
-- Name: get_time_off_access_level(uuid); Type: FUNCTION; Schema: public; Owner: -
--

CREATE FUNCTION public.get_time_off_access_level(p_user_id uuid) RETURNS public.time_off_access_level
    LANGUAGE plpgsql SECURITY DEFINER
    AS $$
DECLARE
    v_user_role TEXT;
...
--
-- Name: get_time_off_requests(uuid, date, date); Type: FUNCTION; Schema: public; Owner: -
--

CREATE FUNCTION public.get_time_off_requests(p_user_id uuid DEFAULT NULL::uuid, p_start_date date DEFAULT NULL::date, p_end_date date DEFAULT NULL::date) RETURNS TABLE(id uuid, employee_id uuid, employee_name text, employee_email text, start_date date, end_date date, request_type text, status text, notes text, created_at timestamp with time zone, updated_at timestamp with time zone)
    LANGUAGE plpgsql SECURITY DEFINER
    AS $$
DECLARE
    v_access_level time_off_access_level;
...
--
-- Name: get_user_auth_history(uuid, interval); Type: FUNCTION; Schema: public; Owner: -
--

CREATE FUNCTION public.get_user_auth_history(p_user_id uuid, p_time_window interval DEFAULT '30 days'::interval) RETURNS TABLE(event_type text, event_count bigint, last_occurrence timestamp with time zone)
    LANGUAGE plpgsql STABLE SECURITY DEFINER
    AS $$
BEGIN
    RETURN QUERY
...
--
-- Name: get_week_number(date, text); Type: FUNCTION; Schema: public; Owner: -
--

CREATE FUNCTION public.get_week_number(p_date date, p_timezone text DEFAULT 'UTC'::text) RETURNS integer
    LANGUAGE plpgsql IMMUTABLE
    AS $$
DECLARE
    v_timestamp TIMESTAMP;
...
--
-- Name: handle_deleted_user(); Type: FUNCTION; Schema: public; Owner: -
--
...
--
-- Name: is_valid_cookie_name(text); Type: FUNCTION; Schema: public; Owner: -
--

CREATE FUNCTION public.is_valid_cookie_name(p_cookie_name text) RETURNS boolean
    LANGUAGE plpgsql IMMUTABLE
    AS $_$
BEGIN
...
--
-- Name: is_valid_cookie_value(text); Type: FUNCTION; Schema: public; Owner: -
--

CREATE FUNCTION public.is_valid_cookie_value(p_cookie_value text) RETURNS boolean
    LANGUAGE plpgsql IMMUTABLE
    AS $_$
BEGIN
...
--
-- Name: is_valid_timezone(text); Type: FUNCTION; Schema: public; Owner: -
--
...
--
-- Name: log_auth_error(uuid, text, text, text, jsonb, text, text); Type: FUNCTION; Schema: public; Owner: -
--

CREATE FUNCTION public.log_auth_error(p_user_id uuid, p_action text, p_error_code text, p_error_message text, p_error_details jsonb DEFAULT '{}'::jsonb, p_ip_address text DEFAULT NULL::text, p_user_agent text DEFAULT NULL::text) RETURNS uuid
    LANGUAGE plpgsql SECURITY DEFINER
    AS $$
DECLARE
    v_error_id UUID;
...
--
-- Name: log_auth_error(public.auth_error_type, text, text, jsonb, uuid, uuid, public.auth_error_severity); Type: FUNCTION; Schema: public; Owner: -
--

CREATE FUNCTION public.log_auth_error(p_error_type public.auth_error_type, p_error_code text, p_error_message text, p_error_details jsonb DEFAULT NULL::jsonb, p_user_id uuid DEFAULT NULL::uuid, p_session_id uuid DEFAULT NULL::uuid, p_severity public.auth_error_severity DEFAULT 'MEDIUM'::public.auth_error_severity) RETURNS uuid
    LANGUAGE plpgsql SECURITY DEFINER
    AS $$
DECLARE
    v_error_id UUID;
...
--
-- Name: log_auth_event(text, uuid, jsonb, jsonb); Type: FUNCTION; Schema: public; Owner: -
--

CREATE FUNCTION public.log_auth_event(p_event_type text, p_user_id uuid DEFAULT NULL::uuid, p_metadata jsonb DEFAULT NULL::jsonb, p_client_info jsonb DEFAULT NULL::jsonb) RETURNS uuid
    LANGUAGE plpgsql SECURITY DEFINER
    AS $$
DECLARE
    v_event_id UUID;
...
--
-- Name: log_auth_event(text, uuid, jsonb, boolean, uuid, uuid); Type: FUNCTION; Schema: public; Owner: -
--

CREATE FUNCTION public.log_auth_event(p_event_type text, p_user_id uuid DEFAULT NULL::uuid, p_metadata jsonb DEFAULT NULL::jsonb, p_success boolean DEFAULT true, p_error_id uuid DEFAULT NULL::uuid, p_session_id uuid DEFAULT NULL::uuid) RETURNS uuid
    LANGUAGE plpgsql SECURITY DEFINER
    AS $$
DECLARE
    v_event_id UUID;
...
--
-- Name: log_confirmation_attempt(text, text, text, text, text, boolean, text); Type: FUNCTION; Schema: public; Owner: -
--

CREATE FUNCTION public.log_confirmation_attempt(p_email text, p_type text, p_token_hash text, p_ip_address text, p_user_agent text, p_success boolean, p_error_message text DEFAULT NULL::text) RETURNS uuid
    LANGUAGE plpgsql SECURITY DEFINER
    AS $$
DECLARE
    v_attempt_id UUID;
...
--
-- Name: log_employee_access(uuid, text, boolean, text, jsonb); Type: FUNCTION; Schema: public; Owner: -
--

CREATE FUNCTION public.log_employee_access(p_accessed_employee_id uuid, p_action_type text, p_success boolean DEFAULT true, p_error_message text DEFAULT NULL::text, p_client_info jsonb DEFAULT NULL::jsonb) RETURNS uuid
    LANGUAGE plpgsql SECURITY DEFINER
    AS $$
DECLARE
    v_log_id UUID;
...
--
-- Name: log_error_action(text, text, timestamp with time zone, jsonb); Type: FUNCTION; Schema: public; Owner: -
--

CREATE FUNCTION public.log_error_action(p_action text, p_path text, p_timestamp timestamp with time zone DEFAULT now(), p_metadata jsonb DEFAULT '{}'::jsonb) RETURNS uuid
    LANGUAGE plpgsql SECURITY DEFINER
    AS $$
DECLARE
    v_action_id UUID;
...
--
-- Name: log_error_metrics(text, jsonb, jsonb); Type: FUNCTION; Schema: public; Owner: -
--

CREATE FUNCTION public.log_error_metrics(p_component text, p_metrics jsonb, p_error_details jsonb DEFAULT NULL::jsonb) RETURNS uuid
    LANGUAGE plpgsql SECURITY DEFINER
    AS $$
DECLARE
    v_metric_id UUID;
...
--
-- Name: log_network_retry_metrics(text, text, jsonb, jsonb); Type: FUNCTION; Schema: public; Owner: -
--

CREATE FUNCTION public.log_network_retry_metrics(p_component text, p_endpoint text, p_metrics jsonb, p_retry_details jsonb DEFAULT NULL::jsonb) RETURNS uuid
    LANGUAGE plpgsql SECURITY DEFINER
    AS $$
DECLARE
    v_metric_id UUID;
...
--
-- Name: log_time_off_access(uuid, uuid, public.time_off_access_level, jsonb, text, text); Type: FUNCTION; Schema: public; Owner: -
--

CREATE FUNCTION public.log_time_off_access(p_user_id uuid, p_accessed_user_id uuid, p_access_type public.time_off_access_level, p_client_info jsonb DEFAULT NULL::jsonb, p_request_path text DEFAULT NULL::text, p_request_method text DEFAULT NULL::text) RETURNS uuid
    LANGUAGE plpgsql SECURITY DEFINER
    AS $$
DECLARE
    v_log_id UUID;
...
--
-- Name: normalize_period_format(text, public.period_format, public.period_format); Type: FUNCTION; Schema: public; Owner: -
--

CREATE FUNCTION public.normalize_period_format(p_period_id text, p_source_format public.period_format DEFAULT 'HH:MM-HH:MM'::public.period_format, p_target_format public.period_format DEFAULT 'HH:MM-HH:MM'::public.period_format) RETURNS text
    LANGUAGE plpgsql IMMUTABLE
    AS $$
DECLARE
    v_start_time TEXT;
...
--
-- Name: period_crosses_midnight(text, text); Type: FUNCTION; Schema: public; Owner: -
--

CREATE FUNCTION public.period_crosses_midnight(p_start_time text, p_end_time text) RETURNS boolean
    LANGUAGE plpgsql IMMUTABLE
    AS $$
BEGIN
    RETURN (
...
--
-- Name: prevent_overlapping_patterns(); Type: FUNCTION; Schema: public; Owner: -
--

CREATE FUNCTION public.prevent_overlapping_patterns() RETURNS trigger
    LANGUAGE plpgsql
    AS $$
BEGIN
    IF EXISTS (
...
--
-- Name: prevent_schedule_overlap(); Type: FUNCTION; Schema: public; Owner: -
--
...
--
-- Name: process_error_analytics_batch(uuid); Type: FUNCTION; Schema: public; Owner: -
--

CREATE FUNCTION public.process_error_analytics_batch(p_batch_id uuid) RETURNS void
    LANGUAGE plpgsql SECURITY DEFINER
    AS $$
DECLARE
    v_config public.error_analytics_config%ROWTYPE;
...
--
-- Name: record_scheduler_metrics(text, jsonb, text, timestamp with time zone); Type: FUNCTION; Schema: public; Owner: -
--

CREATE FUNCTION public.record_scheduler_metrics(p_metrics_type text, p_metrics_value jsonb, p_environment text DEFAULT current_setting('app.environment'::text, true), p_measured_at timestamp with time zone DEFAULT now()) RETURNS uuid
    LANGUAGE plpgsql SECURITY DEFINER
    AS $$
DECLARE
    v_metrics_id UUID;
...
--
-- Name: resolve_auth_error(uuid, text); Type: FUNCTION; Schema: public; Owner: -
--

CREATE FUNCTION public.resolve_auth_error(p_error_id uuid, p_resolution_details text) RETURNS boolean
    LANGUAGE plpgsql SECURITY DEFINER
    AS $$
BEGIN
...
--
-- Name: FUNCTION rollback_transaction(); Type: COMMENT; Schema: public; Owner: -
--
...
--
-- Name: save_error_analytics_data(text, text, jsonb, integer); Type: FUNCTION; Schema: public; Owner: -
--

CREATE FUNCTION public.save_error_analytics_data(p_component text, p_storage_key text, p_data jsonb, p_size_bytes integer) RETURNS uuid
    LANGUAGE plpgsql SECURITY DEFINER
    AS $$
DECLARE
    v_storage_id UUID;
...
--
-- Name: shifts_overlap(time without time zone, time without time zone, time without time zone, time without time zone); Type: FUNCTION; Schema: public; Owner: -
--

CREATE FUNCTION public.shifts_overlap(p_start1 time without time zone, p_end1 time without time zone, p_start2 time without time zone, p_end2 time without time zone) RETURNS boolean
    LANGUAGE plpgsql IMMUTABLE
    AS $$
BEGIN
...
--
-- Name: standardize_timestamps(); Type: FUNCTION; Schema: public; Owner: -
--

CREATE FUNCTION public.standardize_timestamps() RETURNS trigger
    LANGUAGE plpgsql SECURITY DEFINER
    AS $$
BEGIN
...
--
-- Name: standardize_timezone(timestamp with time zone, text); Type: FUNCTION; Schema: public; Owner: -
--

CREATE FUNCTION public.standardize_timezone(p_timestamp timestamp with time zone, p_source_zone text DEFAULT NULL::text) RETURNS timestamp with time zone
    LANGUAGE plpgsql IMMUTABLE
    AS $$
BEGIN
...
--
-- Name: track_employee_operation(uuid, public.employee_operation, public.operation_severity, jsonb, jsonb); Type: FUNCTION; Schema: public; Owner: -
--

CREATE FUNCTION public.track_employee_operation(p_employee_id uuid, p_operation public.employee_operation, p_severity public.operation_severity DEFAULT 'LOW'::public.operation_severity, p_metadata jsonb DEFAULT '{}'::jsonb, p_client_info jsonb DEFAULT '{}'::jsonb) RETURNS uuid
    LANGUAGE plpgsql SECURITY DEFINER
    AS $$
DECLARE
    v_operation_id UUID;
...
--
-- Name: track_schedule_operation(uuid, public.schedule_operation, jsonb, jsonb, jsonb); Type: FUNCTION; Schema: public; Owner: -
--

CREATE FUNCTION public.track_schedule_operation(p_schedule_id uuid, p_operation public.schedule_operation, p_previous_state jsonb DEFAULT NULL::jsonb, p_new_state jsonb DEFAULT NULL::jsonb, p_metadata jsonb DEFAULT '{}'::jsonb) RETURNS uuid
    LANGUAGE plpgsql SECURITY DEFINER
    AS $$
DECLARE
    v_operation_id UUID;
...
--
-- Name: update_coverage_status(); Type: FUNCTION; Schema: public; Owner: -
--

CREATE FUNCTION public.update_coverage_status() RETURNS trigger
    LANGUAGE plpgsql
    AS $$
BEGIN
...
--
-- Name: update_employee_and_profile(uuid, text, text, public.employee_role_enum, integer, uuid, boolean, integer); Type: FUNCTION; Schema: public; Owner: -
--

CREATE FUNCTION public.update_employee_and_profile(p_employee_id uuid, p_full_name text, p_username text, p_employee_role public.employee_role_enum, p_weekly_hours_scheduled integer, p_default_shift_type_id uuid DEFAULT NULL::uuid, p_allow_overtime boolean DEFAULT false, p_max_weekly_hours integer DEFAULT 40) RETURNS public.employees
    LANGUAGE plpgsql SECURITY DEFINER
    AS $$
DECLARE
...
--
-- Name: update_employee_role(uuid, public.employee_role, text, jsonb); Type: FUNCTION; Schema: public; Owner: -
--

CREATE FUNCTION public.update_employee_role(p_employee_id uuid, p_new_role public.employee_role, p_reason text DEFAULT NULL::text, p_client_info jsonb DEFAULT NULL::jsonb) RETURNS boolean
    LANGUAGE plpgsql SECURITY DEFINER
    AS $$
DECLARE
...
--
-- Name: update_error_analytics_storage_updated_at(); Type: FUNCTION; Schema: public; Owner: -
--

CREATE FUNCTION public.update_error_analytics_storage_updated_at() RETURNS trigger
    LANGUAGE plpgsql
    AS $$
BEGIN
    NEW.updated_at = NOW();
...
--
-- Name: update_error_analytics_timestamp(); Type: FUNCTION; Schema: public; Owner: -
--

CREATE FUNCTION public.update_error_analytics_timestamp() RETURNS trigger
    LANGUAGE plpgsql
    AS $$
BEGIN
    NEW.updated_at = NOW();
...
--
-- Name: update_error_metrics_updated_at(); Type: FUNCTION; Schema: public; Owner: -
--

CREATE FUNCTION public.update_error_metrics_updated_at() RETURNS trigger
    LANGUAGE plpgsql
    AS $$
BEGIN
    NEW.updated_at = NOW();
...
--
-- Name: update_network_retry_metrics_updated_at(); Type: FUNCTION; Schema: public; Owner: -
--

CREATE FUNCTION public.update_network_retry_metrics_updated_at() RETURNS trigger
    LANGUAGE plpgsql
    AS $$
BEGIN
    NEW.updated_at = NOW();
...
--
-- Name: update_rate_limit_timestamp(); Type: FUNCTION; Schema: public; Owner: -
--

CREATE FUNCTION public.update_rate_limit_timestamp() RETURNS trigger
    LANGUAGE plpgsql
    AS $$
BEGIN
    NEW.updated_at = NOW();
...
--
-- Name: update_scheduler_config(text, jsonb, text, text); Type: FUNCTION; Schema: public; Owner: -
--

CREATE FUNCTION public.update_scheduler_config(p_config_key text, p_config_value jsonb, p_environment text DEFAULT current_setting('app.environment'::text, true), p_description text DEFAULT NULL::text) RETURNS uuid
    LANGUAGE plpgsql SECURITY DEFINER
    AS $$
DECLARE
    v_config_id UUID;
...
--
-- Name: validate_business_hours(time without time zone, time without time zone, text); Type: FUNCTION; Schema: public; Owner: -
--

CREATE FUNCTION public.validate_business_hours(p_start_time time without time zone, p_end_time time without time zone, p_timezone text DEFAULT 'UTC'::text) RETURNS boolean
    LANGUAGE plpgsql STABLE SECURITY DEFINER
    AS $$
BEGIN
...
--
-- Name: validate_date_range(timestamp with time zone, timestamp with time zone, boolean); Type: FUNCTION; Schema: public; Owner: -
--

CREATE FUNCTION public.validate_date_range(p_start_date timestamp with time zone, p_end_date timestamp with time zone, p_allow_null_end boolean DEFAULT false) RETURNS boolean
    LANGUAGE plpgsql IMMUTABLE
    AS $$
BEGIN
...
--
-- Name: validate_jwt_template(jsonb); Type: FUNCTION; Schema: public; Owner: -
--

CREATE FUNCTION public.validate_jwt_template(template jsonb) RETURNS boolean
    LANGUAGE plpgsql SECURITY DEFINER
    AS $$
BEGIN
...
--
-- Name: validate_overtime(); Type: FUNCTION; Schema: public; Owner: -
--

CREATE FUNCTION public.validate_overtime() RETURNS trigger
    LANGUAGE plpgsql
    AS $$
DECLARE
...
--
-- Name: validate_password(text, text); Type: FUNCTION; Schema: public; Owner: -
--

CREATE FUNCTION public.validate_password(p_password text, p_policy_name text DEFAULT 'default'::text) RETURNS boolean
    LANGUAGE plpgsql SECURITY DEFINER
    AS $_$
DECLARE
    v_policy password_policy;
...
--
-- Name: validate_period_format(text, public.period_format); Type: FUNCTION; Schema: public; Owner: -
--

CREATE FUNCTION public.validate_period_format(p_period_id text, p_format public.period_format DEFAULT 'HH:MM-HH:MM'::public.period_format) RETURNS boolean
    LANGUAGE plpgsql IMMUTABLE
    AS $_$
DECLARE
    v_pattern TEXT;
...
--
-- Name: validate_role_change(uuid, public.employee_role, uuid); Type: FUNCTION; Schema: public; Owner: -
--

CREATE FUNCTION public.validate_role_change(p_employee_id uuid, p_new_role public.employee_role, p_changed_by uuid) RETURNS boolean
    LANGUAGE plpgsql SECURITY DEFINER
    AS $$
DECLARE
...
--
-- Name: validate_schedule(); Type: FUNCTION; Schema: public; Owner: -
--

CREATE FUNCTION public.validate_schedule() RETURNS trigger
    LANGUAGE plpgsql
    AS $$
BEGIN
...
--
-- Name: validate_schedule_against_pattern(uuid, date); Type: FUNCTION; Schema: public; Owner: -
--

CREATE FUNCTION public.validate_schedule_against_pattern(p_employee_id uuid, p_date date) RETURNS boolean
    LANGUAGE plpgsql
    AS $$
DECLARE
    v_pattern RECORD;
...
--
-- Name: validate_schedule_overlap(uuid, timestamp with time zone, timestamp with time zone, uuid); Type: FUNCTION; Schema: public; Owner: -
--

CREATE FUNCTION public.validate_schedule_overlap(p_employee_id uuid, p_period_start timestamp with time zone, p_period_end timestamp with time zone, p_exclude_id uuid DEFAULT NULL::uuid) RETURNS boolean
    LANGUAGE plpgsql STABLE SECURITY DEFINER
    AS $$
BEGIN
    RETURN NOT EXISTS (
...
--
-- Name: validate_schedule_status_transition(); Type: FUNCTION; Schema: public; Owner: -
--

CREATE FUNCTION public.validate_schedule_status_transition() RETURNS trigger
    LANGUAGE plpgsql
    AS $$
BEGIN
...
--
-- Name: validate_shift_assignment(uuid, uuid, date); Type: FUNCTION; Schema: public; Owner: -
--

CREATE FUNCTION public.validate_shift_assignment(p_employee_id uuid, p_shift_id uuid, p_date date) RETURNS jsonb
    LANGUAGE plpgsql SECURITY DEFINER
    SET search_path TO 'public'
    AS $$
declare
...
--
-- Name: validate_shift_overlap(uuid, uuid, timestamp with time zone, timestamp with time zone); Type: FUNCTION; Schema: public; Owner: -
--

CREATE FUNCTION public.validate_shift_overlap(p_shift_id uuid, p_employee_id uuid, p_start_time timestamp with time zone, p_end_time timestamp with time zone) RETURNS TABLE(is_valid boolean, overlap_count integer, message text)
    LANGUAGE plpgsql SECURITY DEFINER
    AS $$
DECLARE
...
--
-- Name: validate_shift_pattern(); Type: FUNCTION; Schema: public; Owner: -
--

CREATE FUNCTION public.validate_shift_pattern() RETURNS trigger
    LANGUAGE plpgsql
    AS $$
DECLARE
...
--
-- Name: validate_shift_pattern(jsonb, jsonb, text); Type: FUNCTION; Schema: public; Owner: -
--

CREATE FUNCTION public.validate_shift_pattern(p_shifts jsonb, p_pattern jsonb, p_timezone text DEFAULT 'UTC'::text) RETURNS TABLE(is_valid boolean, error_code text, error_message text, error_details jsonb)
    LANGUAGE plpgsql SECURITY DEFINER
    AS $$
DECLARE
    v_shift RECORD;
...
--
-- Name: validate_shift_times(); Type: FUNCTION; Schema: public; Owner: -
--

CREATE FUNCTION public.validate_shift_times() RETURNS trigger
    LANGUAGE plpgsql
    AS $$
BEGIN
...
--
-- Name: validate_shift_trigger(); Type: FUNCTION; Schema: public; Owner: -
--

CREATE FUNCTION public.validate_shift_trigger() RETURNS trigger
    LANGUAGE plpgsql SECURITY DEFINER
    AS $$
DECLARE
  v_validation RECORD;
...
--
-- Name: validate_staffing_requirements(uuid, date, text); Type: FUNCTION; Schema: public; Owner: -
--

CREATE FUNCTION public.validate_staffing_requirements(p_schedule_id uuid, p_date date, p_timezone text DEFAULT 'UTC'::text) RETURNS TABLE(is_valid boolean, error_code text, error_message text, error_details jsonb)
    LANGUAGE plpgsql SECURITY DEFINER
    AS $$
DECLARE
...
--
-- Name: validate_time_off_request(uuid, date, date, text, text); Type: FUNCTION; Schema: public; Owner: -
--

CREATE FUNCTION public.validate_time_off_request(p_user_id uuid, p_start_date date, p_end_date date, p_request_type text, p_reason text) RETURNS jsonb
    LANGUAGE plpgsql SECURITY DEFINER
    SET search_path TO 'public'
    AS $$
declare
...
--
-- Name: FUNCTION validate_time_off_request(p_user_id uuid, p_start_date date, p_end_date date, p_request_type text, p_reason text); Type: COMMENT; Schema: public; Owner: -
--
...
--
-- Name: auth_confirmation_attempts; Type: TABLE; Schema: public; Owner: -
--
...
--
-- Name: auth_error_logs; Type: TABLE; Schema: public; Owner: -
--
...
--
-- Name: auth_errors; Type: TABLE; Schema: public; Owner: -
--
...
--
-- Name: cookie_errors; Type: TABLE; Schema: public; Owner: -
--
...
--
-- Name: cookie_metrics; Type: TABLE; Schema: public; Owner: -
--
...
--
-- Name: daily_coverage; Type: TABLE; Schema: public; Owner: -
--
...
--
-- Name: employee_access_logs; Type: TABLE; Schema: public; Owner: -
--
...
--
-- Name: employee_patterns; Type: TABLE; Schema: public; Owner: -
--
...
--
-- Name: employee_role_history; Type: TABLE; Schema: public; Owner: -
--
...
--
-- Name: employee_shift_preferences; Type: TABLE; Schema: public; Owner: -
--
...
--
-- Name: error_actions; Type: TABLE; Schema: public; Owner: -
--
...
--
-- Name: error_analytics_config; Type: TABLE; Schema: public; Owner: -
--
...
--
-- Name: error_analytics_data; Type: TABLE; Schema: public; Owner: -
--
...
--
-- Name: error_analytics_storage; Type: TABLE; Schema: public; Owner: -
--
...
--
-- Name: error_analytics_trends; Type: TABLE; Schema: public; Owner: -
--
...
--
-- Name: error_metrics; Type: TABLE; Schema: public; Owner: -
--
...
--
-- Name: error_status_codes; Type: TABLE; Schema: public; Owner: -
--
...
--
-- Name: jwt_audit_logs; Type: TABLE; Schema: public; Owner: -
--
...
--
-- Name: network_retry_metrics; Type: TABLE; Schema: public; Owner: -
--
...
--
-- Name: pattern_actions; Type: TABLE; Schema: public; Owner: -
--
...
--
-- Name: period_format_issues; Type: TABLE; Schema: public; Owner: -
--
...
--
-- Name: rate_limit_metrics; Type: TABLE; Schema: public; Owner: -
--
...
--
-- Name: scheduler_metrics; Type: TABLE; Schema: public; Owner: -
--
...
--
-- Name: scheduler_metrics_history; Type: TABLE; Schema: public; Owner: -
--
...
--
-- Name: TABLE shift_patterns; Type: COMMENT; Schema: public; Owner: -
--
...
--
-- Name: time_off_access_logs; Type: TABLE; Schema: public; Owner: -
--
...
--
-- Name: timezone_configs; Type: TABLE; Schema: public; Owner: -
--
...
--
-- Name: auth_confirmation_attempts auth_confirmation_attempts_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: auth_error_logs auth_error_logs_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: auth_errors auth_errors_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: cookie_errors cookie_errors_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: cookie_metrics cookie_metrics_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: daily_coverage daily_coverage_date_period_key; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: daily_coverage daily_coverage_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: employee_access_logs employee_access_logs_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: employee_operations employee_operations_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: employee_patterns employee_patterns_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: employee_role_history employee_role_history_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: employee_shift_preferences employee_shift_preferences_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: error_actions error_actions_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: error_analytics_config error_analytics_config_component_key; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: error_analytics_config error_analytics_config_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: error_analytics_data error_analytics_data_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: error_analytics_storage error_analytics_storage_component_storage_key_key; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: error_analytics_storage error_analytics_storage_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: error_analytics_trends error_analytics_trends_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: error_metrics error_metrics_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: error_status_codes error_status_codes_error_code_key; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: error_status_codes error_status_codes_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: jwt_audit_logs jwt_audit_logs_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: jwt_templates jwt_templates_name_key; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: jwt_templates jwt_templates_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: network_retry_metrics network_retry_metrics_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: password_history password_history_user_id_password_hash_key; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: password_policies password_policies_name_key; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: pattern_actions pattern_actions_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: period_format_issues period_format_issues_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: rate_limit_config rate_limit_config_key_key; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: rate_limit_metrics rate_limit_metrics_key_user_id_window_start_key; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: rate_limit_metrics rate_limit_metrics_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: schedule_operations schedule_operations_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: schedule_settings schedule_settings_organization_id_key; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: scheduler_config scheduler_config_config_key_environment_key; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: scheduler_metrics_history scheduler_metrics_history_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: scheduler_metrics scheduler_metrics_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: shift_patterns shift_patterns_name_key; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: shift_types shift_types_name_key; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: staffing_requirements staffing_requirements_name_key; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: storage_quotas storage_quotas_component_key; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: time_off_access_logs time_off_access_logs_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: timezone_configs timezone_configs_name_key; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: timezone_configs timezone_configs_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: validation_rules validation_rules_rule_type_rule_name_key; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: idx_access_logs_accessed; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_access_logs_accessor; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_auth_confirmation_attempts_created; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_auth_confirmation_attempts_email; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_auth_confirmation_attempts_ip; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_auth_error_logs_created_at; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_auth_error_logs_error_type; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_auth_error_logs_user_id; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_auth_errors_action; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_auth_errors_created; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_auth_errors_user; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_auth_event_logs_created_at; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_auth_event_logs_event_type; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_auth_event_logs_user_id; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_auth_events_type; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_cookie_errors_cookie; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_cookie_errors_type; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_cookie_errors_user; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_cookie_metrics_name; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_cookie_metrics_operation; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_cookie_metrics_success; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_cookie_metrics_user; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_coverage_date; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_daily_coverage_date; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_daily_coverage_period; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_daily_coverage_status; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_employee_operations_created; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_employee_operations_employee; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_employee_operations_status; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_employee_patterns_date; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_employee_patterns_dates; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_employee_patterns_employee; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_employee_patterns_pattern; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_error_actions_timestamp; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_error_actions_user; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_error_analytics_component; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_error_analytics_data_component; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_error_analytics_data_timestamp; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_error_analytics_last_accessed; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_error_analytics_trends_component; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_error_metrics_component; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_error_metrics_last_error; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_jwt_audit_logs_issued; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_jwt_audit_logs_template; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_jwt_audit_logs_user; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_network_retry_metrics_component; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_network_retry_metrics_endpoint; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_organization_users_org; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_organization_users_user; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_pattern_actions_created; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_pattern_actions_pattern; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_pattern_actions_user; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_period_format_issues_component; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_period_format_issues_created; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_rate_limit_metrics_key_user; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_rate_limit_metrics_window; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_role_history_changed_at; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_role_history_changed_by; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_role_history_employee; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_schedule_operations_schedule; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_schedule_operations_status; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_scheduler_metrics_created_at; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_scheduler_metrics_history_measured_at; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_scheduler_metrics_history_type_env; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_schedules_employee; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_schedules_employee_date; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_shift_preferences_dates; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_shift_preferences_employee; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_time_off_access_accessed; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_time_off_access_time; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_time_off_access_user; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_time_off_requests_employee; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_validation_history_schedule; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: time_off_requests_employee_id_idx; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: time_off_requests_status_idx; Type: INDEX; Schema: public; Owner: -
--
...
CREATE TRIGGER audit_employees AFTER INSERT OR DELETE OR UPDATE ON public.employees FOR EACH ROW EXECUTE FUNCTION public.create_audit_log();
...
CREATE TRIGGER audit_schedules AFTER INSERT OR DELETE OR UPDATE ON public.schedules FOR EACH ROW EXECUTE FUNCTION public.create_audit_log();


--
-- Name: time_off_requests audit_time_off_requests; Type: TRIGGER; Schema: public; Owner: -
--

CREATE TRIGGER audit_time_off_requests AFTER INSERT OR DELETE OR UPDATE ON public.time_off_requests FOR EACH ROW EXECUTE FUNCTION public.create_audit_log();


--
-- Name: schedules check_schedule_conflicts_trigger; Type: TRIGGER; Schema: public; Owner: -
--

CREATE TRIGGER check_schedule_conflicts_trigger BEFORE INSERT OR UPDATE ON public.schedules FOR EACH ROW EXECUTE FUNCTION public.check_schedule_conflicts();


--
-- Name: employees on_employee_deleted; Type: TRIGGER; Schema: public; Owner: -
--

CREATE TRIGGER on_employee_deleted AFTER DELETE ON public.employees FOR EACH ROW EXECUTE FUNCTION public.handle_deleted_user();


--
-- Name: employee_patterns prevent_overlapping_patterns_trigger; Type: TRIGGER; Schema: public; Owner: -
--

CREATE TRIGGER prevent_overlapping_patterns_trigger BEFORE INSERT OR UPDATE ON public.employee_patterns FOR EACH ROW EXECUTE FUNCTION public.prevent_overlapping_patterns();


--
-- Name: schedules schedule_status_transition_validation; Type: TRIGGER; Schema: public; Owner: -
--

CREATE TRIGGER schedule_status_transition_validation BEFORE UPDATE ON public.schedules FOR EACH ROW EXECUTE FUNCTION public.validate_schedule_status_transition();


--
-- Name: shifts shift_times_validation; Type: TRIGGER; Schema: public; Owner: -
--

CREATE TRIGGER shift_times_validation BEFORE INSERT OR UPDATE ON public.shifts FOR EACH ROW EXECUTE FUNCTION public.validate_shift_times();


--
-- Name: schedules standardize_schedule_timestamps; Type: TRIGGER; Schema: public; Owner: -
--

CREATE TRIGGER standardize_schedule_timestamps BEFORE INSERT OR UPDATE ON public.schedules FOR EACH ROW EXECUTE FUNCTION public.standardize_timestamps();


--
-- Name: time_off_requests standardize_time_off_timestamps; Type: TRIGGER; Schema: public; Owner: -
--

CREATE TRIGGER standardize_time_off_timestamps BEFORE INSERT OR UPDATE ON public.time_off_requests FOR EACH ROW EXECUTE FUNCTION public.standardize_timestamps();


--
-- Name: schedules update_coverage_trigger; Type: TRIGGER; Schema: public; Owner: -
--

CREATE TRIGGER update_coverage_trigger AFTER INSERT OR DELETE OR UPDATE ON public.schedules FOR EACH ROW EXECUTE FUNCTION public.update_coverage_status();


--
-- Name: daily_coverage update_daily_coverage_updated_at; Type: TRIGGER; Schema: public; Owner: -
--

CREATE TRIGGER update_daily_coverage_updated_at BEFORE UPDATE ON public.daily_coverage FOR EACH ROW EXECUTE FUNCTION public.update_updated_at();


--
-- Name: employee_patterns update_employee_patterns_updated_at; Type: TRIGGER; Schema: public; Owner: -
--

CREATE TRIGGER update_employee_patterns_updated_at BEFORE UPDATE ON public.employee_patterns FOR EACH ROW EXECUTE FUNCTION public.update_updated_at();


--
-- Name: employee_shift_preferences update_employee_shift_preferences_updated_at; Type: TRIGGER; Schema: public; Owner: -
--

CREATE TRIGGER update_employee_shift_preferences_updated_at BEFORE UPDATE ON public.employee_shift_preferences FOR EACH ROW EXECUTE FUNCTION public.update_updated_at();
...
--
-- Name: error_analytics_config update_error_analytics_config_timestamp; Type: TRIGGER; Schema: public; Owner: -
--

CREATE TRIGGER update_error_analytics_config_timestamp BEFORE UPDATE ON public.error_analytics_config FOR EACH ROW EXECUTE FUNCTION public.update_error_analytics_timestamp();


--
-- Name: error_analytics_storage update_error_analytics_storage_timestamp; Type: TRIGGER; Schema: public; Owner: -
--

CREATE TRIGGER update_error_analytics_storage_timestamp BEFORE UPDATE ON public.error_analytics_storage FOR EACH ROW EXECUTE FUNCTION public.update_error_analytics_storage_updated_at();


--
-- Name: error_analytics_trends update_error_analytics_trends_timestamp; Type: TRIGGER; Schema: public; Owner: -
--

CREATE TRIGGER update_error_analytics_trends_timestamp BEFORE UPDATE ON public.error_analytics_trends FOR EACH ROW EXECUTE FUNCTION public.update_error_analytics_timestamp();


--
-- Name: error_metrics update_error_metrics_timestamp; Type: TRIGGER; Schema: public; Owner: -
--

CREATE TRIGGER update_error_metrics_timestamp BEFORE UPDATE ON public.error_metrics FOR EACH ROW EXECUTE FUNCTION public.update_error_metrics_updated_at();


--
-- Name: network_retry_metrics update_network_retry_metrics_timestamp; Type: TRIGGER; Schema: public; Owner: -
--

CREATE TRIGGER update_network_retry_metrics_timestamp BEFORE UPDATE ON public.network_retry_metrics FOR EACH ROW EXECUTE FUNCTION public.update_network_retry_metrics_updated_at();
...
--
-- Name: rate_limit_config update_rate_limit_config_timestamp; Type: TRIGGER; Schema: public; Owner: -
--

CREATE TRIGGER update_rate_limit_config_timestamp BEFORE UPDATE ON public.rate_limit_config FOR EACH ROW EXECUTE FUNCTION public.update_rate_limit_timestamp();


--
-- Name: rate_limit_metrics update_rate_limit_metrics_timestamp; Type: TRIGGER; Schema: public; Owner: -
--

CREATE TRIGGER update_rate_limit_metrics_timestamp BEFORE UPDATE ON public.rate_limit_metrics FOR EACH ROW EXECUTE FUNCTION public.update_rate_limit_timestamp();
...
CREATE TRIGGER update_schedule_settings_updated_at BEFORE UPDATE ON public.schedule_settings FOR EACH ROW EXECUTE FUNCTION public.update_updated_at();
...
CREATE TRIGGER update_schedules_updated_at BEFORE UPDATE ON public.schedules FOR EACH ROW EXECUTE FUNCTION public.update_updated_at();


--
-- Name: shift_patterns update_shift_patterns_updated_at; Type: TRIGGER; Schema: public; Owner: -
--

CREATE TRIGGER update_shift_patterns_updated_at BEFORE UPDATE ON public.shift_patterns FOR EACH ROW EXECUTE FUNCTION public.update_updated_at();


--
-- Name: shift_types update_shift_types_updated_at; Type: TRIGGER; Schema: public; Owner: -
--

CREATE TRIGGER update_shift_types_updated_at BEFORE UPDATE ON public.shift_types FOR EACH ROW EXECUTE FUNCTION public.update_updated_at();
...
CREATE TRIGGER update_staffing_requirements_updated_at BEFORE UPDATE ON public.staffing_requirements FOR EACH ROW EXECUTE FUNCTION public.update_updated_at();
...
--
-- Name: schedules validate_overtime_trigger; Type: TRIGGER; Schema: public; Owner: -
--

CREATE TRIGGER validate_overtime_trigger BEFORE INSERT OR UPDATE ON public.schedules FOR EACH ROW EXECUTE FUNCTION public.validate_overtime();


--
-- Name: schedules validate_schedule_overlap; Type: TRIGGER; Schema: public; Owner: -
--

CREATE TRIGGER validate_schedule_overlap BEFORE INSERT OR UPDATE ON public.schedules FOR EACH ROW EXECUTE FUNCTION public.prevent_schedule_overlap();


--
-- Name: schedules validate_schedule_trigger; Type: TRIGGER; Schema: public; Owner: -
--

CREATE TRIGGER validate_schedule_trigger BEFORE INSERT OR UPDATE ON public.schedules FOR EACH ROW EXECUTE FUNCTION public.validate_schedule();


--
-- Name: shifts validate_shift_overlap; Type: TRIGGER; Schema: public; Owner: -
--

CREATE TRIGGER validate_shift_overlap BEFORE INSERT OR UPDATE ON public.shifts FOR EACH ROW EXECUTE FUNCTION public.validate_shift_trigger();


--
-- Name: schedules validate_shift_pattern_trigger; Type: TRIGGER; Schema: public; Owner: -
--

CREATE TRIGGER validate_shift_pattern_trigger BEFORE INSERT OR UPDATE ON public.schedules FOR EACH ROW EXECUTE FUNCTION public.validate_shift_pattern();
...
--
-- Name: auth_errors auth_errors_user_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: auth_event_logs auth_event_logs_error_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: cookie_errors cookie_errors_user_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: cookie_metrics cookie_metrics_user_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: daily_coverage daily_coverage_period_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: employee_access_logs employee_access_logs_accessed_employee_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: employee_access_logs employee_access_logs_accessor_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: employee_operations employee_operations_created_by_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: employee_operations employee_operations_employee_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: employee_patterns employee_patterns_employee_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: employee_patterns employee_patterns_pattern_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: employee_role_history employee_role_history_changed_by_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: employee_role_history employee_role_history_employee_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: employee_shift_preferences employee_shift_preferences_employee_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: employee_shift_preferences employee_shift_preferences_shift_type_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: employees employees_default_shift_type_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: error_actions error_actions_user_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: employees fk_profile; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: jwt_audit_logs jwt_audit_logs_template_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: jwt_audit_logs jwt_audit_logs_user_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: jwt_templates jwt_templates_created_by_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: jwt_templates jwt_templates_updated_by_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: password_policies password_policies_created_by_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: pattern_actions pattern_actions_pattern_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: pattern_actions pattern_actions_user_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: schedule_operations schedule_operations_created_by_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: schedule_operations schedule_operations_schedule_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: scheduler_config scheduler_config_created_by_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: scheduler_config scheduler_config_updated_by_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: schedules schedules_last_operation_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: schedules schedules_shift_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: time_off_access_logs time_off_access_logs_accessed_user_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: time_off_access_logs time_off_access_logs_user_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: time_off_requests time_off_requests_reviewed_by_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: timezone_configs timezone_configs_created_by_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: timezone_configs timezone_configs_updated_by_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: validation_history validation_history_created_by_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: validation_history validation_history_schedule_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: jwt_templates Admins can manage JWT templates; Type: POLICY; Schema: public; Owner: -
--
...
--
-- Name: error_analytics_config Admins can manage error analytics config; Type: POLICY; Schema: public; Owner: -
--
...
--
-- Name: password_policies Admins can manage password policies; Type: POLICY; Schema: public; Owner: -
--
...
--
-- Name: rate_limit_config Admins can manage rate limit config; Type: POLICY; Schema: public; Owner: -
--
...
--
-- Name: timezone_configs Admins can manage timezone configs; Type: POLICY; Schema: public; Owner: -
--
...
--
-- Name: validation_rules Admins can manage validation rules; Type: POLICY; Schema: public; Owner: -
--
...
--
-- Name: auth_error_logs Admins can read all auth error logs; Type: POLICY; Schema: public; Owner: -
--
...
--
-- Name: auth_event_logs Admins can read all auth event logs; Type: POLICY; Schema: public; Owner: -
--
...
--
-- Name: schedule_settings Admins can update their organization's schedule settings; Type: POLICY; Schema: public; Owner: -
--
...
--
-- Name: jwt_audit_logs Admins can view all JWT audit logs; Type: POLICY; Schema: public; Owner: -
--
...
--
-- Name: time_off_access_logs Admins can view all access logs; Type: POLICY; Schema: public; Owner: -
--
...
--
-- Name: auth_events Admins can view all auth events; Type: POLICY; Schema: public; Owner: -
--
...
--
-- Name: auth_confirmation_attempts Admins can view all confirmation attempts; Type: POLICY; Schema: public; Owner: -
--
...
--
-- Name: cookie_errors Admins can view all cookie errors; Type: POLICY; Schema: public; Owner: -
--
...
--
-- Name: cookie_metrics Admins can view all cookie metrics; Type: POLICY; Schema: public; Owner: -
--
...
--
-- Name: employee_operations Admins can view all employee operations; Type: POLICY; Schema: public; Owner: -
--
...
--
-- Name: error_metrics Admins can view all error metrics; Type: POLICY; Schema: public; Owner: -
--
...
--
-- Name: network_retry_metrics Admins can view all network retry metrics; Type: POLICY; Schema: public; Owner: -
--
...
--
-- Name: pattern_actions Admins can view all pattern actions; Type: POLICY; Schema: public; Owner: -
--
...
--
-- Name: shift_patterns All authenticated users can view patterns; Type: POLICY; Schema: public; Owner: -
--
...
--
-- Name: period_format_issues Authenticated users can view period format issues; Type: POLICY; Schema: public; Owner: -
--
...
--
-- Name: validation_history Authenticated users can view validation history; Type: POLICY; Schema: public; Owner: -
--
...
--
-- Name: error_status_codes Everyone can read error status codes; Type: POLICY; Schema: public; Owner: -
--
...
--
-- Name: shift_patterns Managers can create patterns; Type: POLICY; Schema: public; Owner: -
--
...
--
-- Name: shift_patterns Managers can delete patterns; Type: POLICY; Schema: public; Owner: -
--
...
--
-- Name: validation_history Managers can insert validation history; Type: POLICY; Schema: public; Owner: -
--
...
--
-- Name: shift_patterns Managers can update patterns; Type: POLICY; Schema: public; Owner: -
--
...
--
-- Name: validation_rules Managers can view validation rules; Type: POLICY; Schema: public; Owner: -
--
...
--
-- Name: error_status_codes Only admins can modify error status codes; Type: POLICY; Schema: public; Owner: -
--
...
--
-- Name: time_off_requests Only managers can delete time-off requests; Type: POLICY; Schema: public; Owner: -
--
...
--
-- Name: error_analytics_storage Users can access their component data; Type: POLICY; Schema: public; Owner: -
--
...
--
-- Name: error_actions Users can insert error actions; Type: POLICY; Schema: public; Owner: -
--
...
--
-- Name: error_analytics_data Users can insert error analytics data; Type: POLICY; Schema: public; Owner: -
--
...
--
-- Name: time_off_requests Users can insert their own time-off requests; Type: POLICY; Schema: public; Owner: -
--
...
--
-- Name: storage_quotas Users can manage their component quotas; Type: POLICY; Schema: public; Owner: -
--
...
--
-- Name: auth_error_logs Users can read their own auth error logs; Type: POLICY; Schema: public; Owner: -
--
...
--
-- Name: auth_event_logs Users can read their own auth event logs; Type: POLICY; Schema: public; Owner: -
--
...
--
-- Name: password_history Users can read their own password history; Type: POLICY; Schema: public; Owner: -
--
...
--
-- Name: time_off_requests Users can update their own pending time-off requests; Type: POLICY; Schema: public; Owner: -
--
...
--
-- Name: employee_access_logs Users can view access logs they're involved in; Type: POLICY; Schema: public; Owner: -
--
...
--
-- Name: error_actions Users can view error actions; Type: POLICY; Schema: public; Owner: -
--
...
--
-- Name: error_analytics_trends Users can view their component error analytics; Type: POLICY; Schema: public; Owner: -
--
...
--
-- Name: organization_users Users can view their organization memberships; Type: POLICY; Schema: public; Owner: -
--
...
--
-- Name: schedule_settings Users can view their organization's schedule settings; Type: POLICY; Schema: public; Owner: -
--
...
--
-- Name: jwt_audit_logs Users can view their own JWT audit logs; Type: POLICY; Schema: public; Owner: -
--
...
--
-- Name: time_off_access_logs Users can view their own access logs; Type: POLICY; Schema: public; Owner: -
--
...
--
-- Name: auth_errors Users can view their own auth errors; Type: POLICY; Schema: public; Owner: -
--
...
--
-- Name: auth_events Users can view their own auth events; Type: POLICY; Schema: public; Owner: -
--
...
--
-- Name: cookie_errors Users can view their own cookie errors; Type: POLICY; Schema: public; Owner: -
--
...
--
-- Name: cookie_metrics Users can view their own cookie metrics; Type: POLICY; Schema: public; Owner: -
--
...
--
-- Name: employee_operations Users can view their own operations; Type: POLICY; Schema: public; Owner: -
--
...
--
-- Name: pattern_actions Users can view their own pattern actions; Type: POLICY; Schema: public; Owner: -
--
...
--
-- Name: rate_limit_metrics Users can view their own rate limit metrics; Type: POLICY; Schema: public; Owner: -
--
...
--
-- Name: employee_role_history Users can view their own role history; Type: POLICY; Schema: public; Owner: -
--
...
--
-- Name: schedule_operations Users can view their own schedule operations; Type: POLICY; Schema: public; Owner: -
--
...
--
-- Name: time_off_requests Users can view their own time-off requests; Type: POLICY; Schema: public; Owner: -
--
...
--
-- Name: auth_confirmation_attempts; Type: ROW SECURITY; Schema: public; Owner: -
--

ALTER TABLE public.auth_confirmation_attempts ENABLE ROW LEVEL SECURITY;

--
-- Name: auth_error_logs; Type: ROW SECURITY; Schema: public; Owner: -
--

ALTER TABLE public.auth_error_logs ENABLE ROW LEVEL SECURITY;

--
-- Name: auth_errors; Type: ROW SECURITY; Schema: public; Owner: -
--

ALTER TABLE public.auth_errors ENABLE ROW LEVEL SECURITY;

--
-- Name: auth_event_logs; Type: ROW SECURITY; Schema: public; Owner: -
--
...
--
-- Name: cookie_errors; Type: ROW SECURITY; Schema: public; Owner: -
--

ALTER TABLE public.cookie_errors ENABLE ROW LEVEL SECURITY;

--
-- Name: cookie_metrics; Type: ROW SECURITY; Schema: public; Owner: -
--

ALTER TABLE public.cookie_metrics ENABLE ROW LEVEL SECURITY;

--
-- Name: daily_coverage; Type: ROW SECURITY; Schema: public; Owner: -
--

ALTER TABLE public.daily_coverage ENABLE ROW LEVEL SECURITY;

--
-- Name: employee_access_logs; Type: ROW SECURITY; Schema: public; Owner: -
--

ALTER TABLE public.employee_access_logs ENABLE ROW LEVEL SECURITY;

--
-- Name: employee_operations; Type: ROW SECURITY; Schema: public; Owner: -
--

ALTER TABLE public.employee_operations ENABLE ROW LEVEL SECURITY;

--
-- Name: employee_patterns; Type: ROW SECURITY; Schema: public; Owner: -
--

ALTER TABLE public.employee_patterns ENABLE ROW LEVEL SECURITY;

--
-- Name: employee_role_history; Type: ROW SECURITY; Schema: public; Owner: -
--
...
--
-- Name: employees employees_read_all_managers; Type: POLICY; Schema: public; Owner: -
--
...
--
-- Name: employees employees_read_self; Type: POLICY; Schema: public; Owner: -
--
...
--
-- Name: employees employees_update_managers; Type: POLICY; Schema: public; Owner: -
--
...
--
-- Name: employees employees_update_self; Type: POLICY; Schema: public; Owner: -
--
...
--
-- Name: error_actions; Type: ROW SECURITY; Schema: public; Owner: -
--

ALTER TABLE public.error_actions ENABLE ROW LEVEL SECURITY;

--
-- Name: error_analytics_config; Type: ROW SECURITY; Schema: public; Owner: -
--

ALTER TABLE public.error_analytics_config ENABLE ROW LEVEL SECURITY;

--
-- Name: error_analytics_data; Type: ROW SECURITY; Schema: public; Owner: -
--

ALTER TABLE public.error_analytics_data ENABLE ROW LEVEL SECURITY;

--
-- Name: error_analytics_storage; Type: ROW SECURITY; Schema: public; Owner: -
--

ALTER TABLE public.error_analytics_storage ENABLE ROW LEVEL SECURITY;

--
-- Name: error_analytics_trends; Type: ROW SECURITY; Schema: public; Owner: -
--

ALTER TABLE public.error_analytics_trends ENABLE ROW LEVEL SECURITY;

--
-- Name: error_metrics; Type: ROW SECURITY; Schema: public; Owner: -
--

ALTER TABLE public.error_metrics ENABLE ROW LEVEL SECURITY;

--
-- Name: error_status_codes; Type: ROW SECURITY; Schema: public; Owner: -
--

ALTER TABLE public.error_status_codes ENABLE ROW LEVEL SECURITY;

--
-- Name: jwt_audit_logs; Type: ROW SECURITY; Schema: public; Owner: -
--

ALTER TABLE public.jwt_audit_logs ENABLE ROW LEVEL SECURITY;

--
-- Name: jwt_templates; Type: ROW SECURITY; Schema: public; Owner: -
--

ALTER TABLE public.jwt_templates ENABLE ROW LEVEL SECURITY;

--
-- Name: network_retry_metrics; Type: ROW SECURITY; Schema: public; Owner: -
--
...
--
-- Name: pattern_actions; Type: ROW SECURITY; Schema: public; Owner: -
--

ALTER TABLE public.pattern_actions ENABLE ROW LEVEL SECURITY;

--
-- Name: shift_patterns patterns_read; Type: POLICY; Schema: public; Owner: -
--
...
--
-- Name: shift_patterns patterns_write; Type: POLICY; Schema: public; Owner: -
--
...
--
-- Name: period_format_issues; Type: ROW SECURITY; Schema: public; Owner: -
--
...
--
-- Name: profiles profiles_read_all_managers; Type: POLICY; Schema: public; Owner: -
--
...
--
-- Name: profiles profiles_update_managers; Type: POLICY; Schema: public; Owner: -
--
...
--
-- Name: rate_limit_config; Type: ROW SECURITY; Schema: public; Owner: -
--

ALTER TABLE public.rate_limit_config ENABLE ROW LEVEL SECURITY;

--
-- Name: rate_limit_metrics; Type: ROW SECURITY; Schema: public; Owner: -
--

ALTER TABLE public.rate_limit_metrics ENABLE ROW LEVEL SECURITY;

--
-- Name: schedule_operations; Type: ROW SECURITY; Schema: public; Owner: -
--
...
--
-- Name: schedules schedules_read_all_managers; Type: POLICY; Schema: public; Owner: -
--
...
--
-- Name: schedules schedules_read_self; Type: POLICY; Schema: public; Owner: -
--
...
--
-- Name: schedules schedules_write_managers; Type: POLICY; Schema: public; Owner: -
--
...
--
-- Name: shift_types; Type: ROW SECURITY; Schema: public; Owner: -
--

ALTER TABLE public.shift_types ENABLE ROW LEVEL SECURITY;

--
-- Name: shift_types shift_types_read; Type: POLICY; Schema: public; Owner: -
--
...
--
-- Name: shift_types shift_types_write; Type: POLICY; Schema: public; Owner: -
--
...
--
-- Name: shifts shifts_write_managers; Type: POLICY; Schema: public; Owner: -
--
...
--
-- Name: staffing_requirements staffing_read; Type: POLICY; Schema: public; Owner: -
--
...
--
-- Name: staffing_requirements staffing_write; Type: POLICY; Schema: public; Owner: -
--
...
--
-- Name: time_off_access_logs; Type: ROW SECURITY; Schema: public; Owner: -
--

ALTER TABLE public.time_off_access_logs ENABLE ROW LEVEL SECURITY;

--
-- Name: time_off_requests time_off_admin_access; Type: POLICY; Schema: public; Owner: -
--
...
--
-- Name: time_off_requests time_off_self_read; Type: POLICY; Schema: public; Owner: -
--
...
--
-- Name: timezone_configs; Type: ROW SECURITY; Schema: public; Owner: -
--
